              ...
              <div class="col-lg-12">
                <div class="p-5">
                  <div class="text-center">
                    <h1 class="h4 text-gray-900 mb-4">selamt datang di apelikasi pengaduan</h1>
                  </div>
                  <form class="user" method="post" action="proses_login.php">
                    ...
                    <hr>
                      <a href="register.php" class="btn btn-succes btn-user btn-block">
                        <i class="fa fa-laptop fa-fw"></i> Belum punya Akun...? Silakan Daftar
                      </a>
                      <a href="index2.php" class="btn btn-succes btn-user btn-block">
