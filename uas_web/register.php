              ...
              <div class="col-lg-12">
                <div class="p-5">
                  <div class="text-center">
                    <h1 class="h4 text-gray-900 mb-4">silakan Masukan Biodata untuk Mendaftar Apelikasi pengaduan Masyarakat . </h1>
                  </div>
                  <form method="post" action="proses_register.php" class="user">
                    ...
                    <div class="form-group">
                      <input name="telp" type="text" class="form-control form-control-user" id="exampleInputEmail" aria-describedby="emailHelp" placeholder="masukan Nomer Telphon  Anda..." required>
                    </div>
