...
include 'koneksi.php';
$query = mysqli_query($koneksi, "SELECT*FROM pengaduan,tanggapan WHERE tanggapan. id_pengaduan='$id' AND tanggapan.id_pengaduan");
...
<?php
  if(mysqli_num_rows($query)==0){
    echo"<div class='alert alert-dengan'>Maaf pengaduan anda belum ditanggapi.</div>";
 }else{
...
<div class="form-group"> 
    ...
    <input type="text" name="tgl_tanggapan" class="form-control" readonly value="<?= $data['tgl_pengaduan']; ?>">
</div>
